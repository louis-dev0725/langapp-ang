...
export class Modal {
    ...
    updatePosition(range: Range) {
        ...
        //console.log('y', modalY);
        //console.log('this.height', this.height);
        console.log('windowHeight', windowHeight);
        //console.log('rootNode.scrollTop', rootNode.scrollTop);
        if (modalY + this.height > windowHeight) {
            ...
            //y = Math.max(0, windowHeight - this.height);
            //console.log('new y', modalY);
        }
