...
class m190407_200203_create_table_transactions extends Migration
{
    public function up()
    {
        ...
        $this->createIndex('transactions_userId_money_addedDateTime_isRealMoney_idx', '{{%transactions}}', ['userId', 'money', 'addedDateTime', 'isRealMoney']);
        ...
        $this->addForeignKey('transactions_users_fk', '{{%transactions}}', 'userId', '{{%users}}', 'id', 'CASCADE', 'NO ACTION');
    }
